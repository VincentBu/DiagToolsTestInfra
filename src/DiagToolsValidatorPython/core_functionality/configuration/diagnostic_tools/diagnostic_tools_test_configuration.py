...
from utility.DotNet import dotnet_app


class DiagToolTestCommandConfiguration():
    def __init__(self, conf_file_path: str):
        ...
        console_app_root = os.path.join(self.test_bed, 'TargetApps', 'console')
        self.console_app = dotnet_app.DotNetApp(self.dotnet_root, 'console', console_app_root)

        webapp_root = os.path.join(self.test_bed, 'TargetApps', 'webapp')
        self.webapp_app = dotnet_app.DotNetApp(self.dotnet_root, 'webapp', webapp_root)

        gcdumpplayground_root = os.path.join(self.test_bed, 'TargetApps', 'webapp')
        self.gcdumpplayground_app = dotnet_app.DotNetApp(self.dotnet_root, 'console', gcdumpplayground_root)
    ...
    def __parse_conf_file(self, conf_file_path: str) -> None:
        ...
        try:
            ...
            raise Exception(f'fail to parse config file {conf_file_path}: {ex}')    
